...
import { useRepetiteurDashboard } from "@/services/hooks/repetiteur/useRepetiteurDashboard";
...
export default function RepetiteurDashboardPage() {
  ...
  const {
    ...
    isError,
    error,
  } = useRepetiteurDashboard(user?.id || 0, period as DashboardPeriod);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          <div className="flex items-center justify-center h-screen">
            <div className="text-center">
              ...
              <Button onClick={() => router.push("/repetiteur/home")}>
                Retour à l'accueil
              </Button>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
        ...
        >
          <Button
            variant="ghost"
            size="icon"
            onClick={() => router.push("/repetiteur/home")}
        ...
        {/* Stats Cards */}
        <div className="mb-6">
          <RepetiteurDashboardStats {...dashboardData.statsData} />
        </div>

        {/* Charts Section - Comparison */}
        <div className="grid gap-4 sm:gap-6 lg:grid-cols-2 mb-6">
          <RepetiteurStudentStudyTimeChart data={dashboardData.studyTimeData} />
          <RepetiteurStudentPerformanceChart
        ...
        <div className="mb-6">
          <RepetiteurStudentPerformanceEvolutionChart
            ...
            studentsConfig={dashboardData.studentsConfig}
          />
        </div>
        ...
        {/* Students Quick View Cards */}
        <RepetiteurStudentQuickView
          students={dashboardData.studentsQuickViewData}
        />
      </div>
    </div>
  );
