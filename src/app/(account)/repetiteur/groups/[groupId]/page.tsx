    ...
    startGroupQuiz(
      { groupeId: Number(groupId), quizId },
      {
        onSuccess: (data) => {
          ...
          router.push(`/repetiteur/groups/${groupId}/quiz/${quizId}`);
        },
        onError: (error: any) => {
          toast({
            variant: "error",
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 sm:gap-4 backdrop-blur-sm rounded-3xl p-3 sm:p-4 shadow-sm mb-6">
            ...
            {isChief && (
              <button
                ...
                className="bg-[#548C2F] hover:bg-[#4a7829] text-white px-4 sm:px-6 md:px-6 py-3 text-sm sm:text-base md:text-lg rounded-2xl shadow-lg transition-all hover:shadow-xl w-full sm:w-auto whitespace-nowrap flex items-center justify-center"
              >
            ...
            <div className="flex flex-col items-center gap-6 sm:gap-8 mt-4 sm:mt-8">
              <div className="relative w-full max-w-2xl">
                <EmptyState
                  ...
                  description={
                    isChief
                      ? "Créez votre premier quiz pour commencer à réviser avec votre groupe !"
                      : "Le chef du groupe n'a pas encore créé de quiz. Patientez un peu, les quiz arriveront bientôt !"
                  }
                  icons={[
              ...
              {isChief && (
                <div className="text-center px-4">
                  <p className="text-gray-600 text-base sm:text-lg mb-4 sm:mb-6">
                    Cliquez ci-dessous pour créer votre premier quiz !
                  </p>
              ...
              {paginatedQuizzes.map((quiz, index) => {
                ...
                return (
                  <QuizCard
                    ...
                    onViewGrades={() => {
                      router.push(
                        `/repetiteur/groups/${groupId}/quiz/${quiz.id}/notes`,
                      );
                    }}
                  />
                );
