...
export const Pricing = forwardRef<HTMLDivElement>((props, ref) => {
  ...
  return (
    <section
      className="flex flex-col gap-10 items-center py-10 px-4 sm:px-6 lg:px-8"
      ref={ref}
      id="pricing1"
    >
      ...
      <div className="text-center mb-8 sm:mb-12 px-4">
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#2C3E50] mb-4 sm:mb-6">
      ...
      {/* Pricing Cards */}
      <div className="grid gap-4 sm:gap-6 w-full max-w-7xl grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
        {TIERS.map((tier, i) => (
          <PricingCard
            key={i}
            tier={tier}
