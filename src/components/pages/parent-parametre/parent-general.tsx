...
const CARD_COLORS = [
  "bg-white border border-purple-50", // Blanc avec bordure violet clair
  "bg-white border border-purple-50",
  "bg-white border border-purple-50",
];

export default function ParentSettingsGeneral() {
      ...
      >
        ...
        <Form {...profileForm}>
          ...
          >
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder="Prénom"
                        className="h-11 bg-white border border-gray-200 rounded-xl focus:border-purple-300 focus:ring-purple-100"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
            ...
            <Button
              type="submit"
              className="h-11 px-6 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white font-medium rounded-xl shadow-sm transition-all hover:shadow-md"
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <a
                ...
                className="h-11 px-6 flex items-center justify-center text-purple-600 hover:text-purple-700 text-sm font-medium"
              >
                Mot de passe oublié?
              </a>
            </div>
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      ...
                      className="min-h-[120px] bg-white border border-gray-200 rounded-xl focus:border-purple-300 focus:ring-purple-100 resize-none"
                      {...field}
                      maxLength={500}
                    />
                  </FormControl>
