        ...
        <div className="flex flex-col items-center gap-6 sm:gap-8 mt-4 sm:mt-8">
          <div className="relative w-full max-w-2xl">
            <EmptyState
              ...
              description={`Générez le premier quiz personnalisé pour ${enfant.prenom} et aidez-le à réviser efficacement !`}
              icons={[
          ...
          <div className="text-center px-4">
            <p className="text-gray-600 text-base sm:text-lg mb-4 sm:mb-6">
              Cliquez ci-dessous pour générer un quiz adapté au niveau de {enfant.prenom}
            </p>
        ...
        <div className="bg-purple-50 border border-purple-200 rounded-xl p-4 mb-4">
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-gray-600">Quiz de</p>
                <h3 className="text-lg font-semibold text-purple-700">
                  {enfant.prenom} {enfant.nom}
                </h3>
              </div>
