...
interface Activity {
  id: string;
  studentName: string;
  studentColor: string; // Couleur pour identifier l'élève
...
interface RepetiteurRecentActivitiesProps {
  activities: Activity[];
}
...
export function RepetiteurRecentActivities({
  activities,
}: RepetiteurRecentActivitiesProps) {
  if (activities.length === 0) {
    return (
      <Card className="bg-white rounded-[24px] shadow-md border-0">
        <CardHeader>
          <CardTitle className="text-lg font-bold text-gray-900">
            Activités récentes des élèves
          </CardTitle>
        </CardHeader>
        <CardContent>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-2">
                      <div
                        ...
                        style={{ backgroundColor: activity.studentColor }}
                      />
