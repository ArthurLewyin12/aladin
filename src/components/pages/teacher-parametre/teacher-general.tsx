...
const CARD_COLORS = [
  "bg-white border border-green-50", // Blanc avec bordure vert clair
  "bg-white border border-green-50",
  "bg-white border border-green-50",
];

export default function TeacherSettingsGeneral() {
      ...
      >
        ...
        <Form {...profileForm}>
          ...
          >
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder="Prénom"
                        className="h-11 bg-white border border-gray-200 rounded-xl focus:border-green-300 focus:ring-green-100"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
            ...
            <Button
              type="submit"
              className="h-11 px-6 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-medium rounded-xl shadow-sm transition-all hover:shadow-md"
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <a
                ...
                className="h-11 px-6 flex items-center justify-center text-green-600 hover:text-green-700 text-sm font-medium"
              >
                Mot de passe oublié?
              </a>
            </div>
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      ...
                      className="min-h-[120px] bg-white border border-gray-200 rounded-xl focus:border-green-300 focus:ring-green-100 resize-none"
                      {...field}
                      maxLength={500}
                    />
                  </FormControl>
