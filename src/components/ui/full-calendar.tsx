    ...
    <div className="flex flex-1 flex-col">
      ...
      <div className="lg:flex lg:flex-auto lg:flex-col">
        ...
        <div className="grid grid-cols-7 border text-center text-xs font-semibold leading-6 lg:flex-none">
          <div className="border-r py-2.5">Dimanche</div>
          <div className="border-r py-2.5">Lundi</div>
          <div className="border-r py-2.5">Mardi</div>
          <div className="border-r py-2.5">Mercredi</div>
          <div className="border-r py-2.5">Jeudi</div>
          <div className="border-r py-2.5">Vendredi</div>
          <div className="py-2.5">Samedi</div>
        </div>
