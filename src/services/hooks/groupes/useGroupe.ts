...
import { getGroupe } from "@/services/controllers/groupe.controller";
import { createQueryKey } from "@/lib/request";

/**
 * Hook de requête pour récupérer un groupe spécifique par son ID.
 ...
 */
export const useGroupe = (groupeId: number) => {
  return useQuery({
    queryKey: createQueryKey("groupes", groupeId),
    queryFn: () => getGroupe(groupeId),
